    ...
    <section className="relative pt-32 lg:pt-36">
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
          ...
          ></span>
          <span className="absolute right-4 bottom-12 h-24 w-24 rounded-3xl bg-primary blur-xl opacity-80"></span>
        </div>
        <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start lg:max-w-none mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
          ...
          <Paragraph className="mt-8">
            ...
            solutions designed to streamline operations, enhance
            decision-making, and drive innovation. NexAI leverages advanced
            machine learning and automation to help you stay ahead in a rapidly
            evolving digital landscape — making your processes smarter, faster,
            and more efficient.
          </Paragraph>

          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row lg:flex-col gap-5 w-full">
              <form
                action="#"
